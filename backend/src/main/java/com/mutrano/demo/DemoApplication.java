...
public class DemoApplication implements CommandLineRunner {
	...
	public DemoApplication(CategoryRepository categoryRepository, ProductRepository productRepository,
	...
	public void run(String... args) throws Exception {
		...
		Payment pagto2 = new BoletoPayment(null, PaymentState.PENDING, ped2,LocalDate.parse("20/10/2017 00:00", dtf), null);
